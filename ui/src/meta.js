(cxl => {
	cxl.ui.meta = {
		'theme-variables': {
			...
			elevation: {
				label: 'Color of the elevation shadow.',
				type: 'color'
			},
			...
			onPrimary: {
				label: 'Color of elements on top of a primary background',
				type: 'color'
			},
			onPrimaryLight: {
				label: 'Color of elements on top of a primaryLight background',
				type: 'color'
			},
			onSecondary: {
				label: 'Color of elements on top of a secondary background',
				type: 'color'
			},
			onSurface: {
				label: 'Color of elements on top of a surface background',
				type: 'color'
			},
			onError: {
				label: 'Color of elements on top of an error background',
				type: 'color'
			},
			primaryLight: {
				label: 'Primary Light Variation Color',
				type: 'color'
			},
		...
		attributes: {
			...
			invalid: {
				summary:
					'Indicates whether or not the component has a valid value'
			},
			...
			touched: {
				summary:
					'Indicates whether or not the component has been blurred'
			},
			'true-value': {
				summary:
					'Value to use when the component is in the checked status'
			},
